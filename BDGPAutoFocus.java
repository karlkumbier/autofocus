...
//	public float data[] = null;
	...
	public ImageProcessor getImageProcessorForImagePath(String path) {
		ImagePlus imagePlus = new ImagePlus(path);
		return imagePlus.getProcessor();
	}

	public static void main(String[] args) {
		BDGPAutoFocus autoFocus = new BDGPAutoFocus();
		String path = args[0];
		ImageProcessor processor = autoFocus.getImageProcessorForImagePath(path);

		autoFocus.computeFFT(processor, 15, 80, 1);
	}
}
